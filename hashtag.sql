...
CREATE TABLE `Mycircle` (
  `Mycircle_id` int(11) NOT NULL,
  `Mycircle` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Indexes for table `Mycircle`
--
ALTER TABLE `Mycircle`
  ADD PRIMARY KEY (`Mycircle_id`);
...
--
-- AUTO_INCREMENT for table `Mycircle`
--
ALTER TABLE `Mycircle`
  MODIFY `Mycircle_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
