...
<div class="senapati pro_senapati">
  ...
  <div class="srajkumar post_srajkumar">

    <?php if($universal->MeOrNot($get_id) == false && $universal->isLoggedIn()){ ?>
    <div class="mutuals inst">
      <?php $mutual->propleYouKnow($get_id); ?>
    </div>
    <?php } ?>
    ...
    <div class="grp_mem_teaser inst">
      ...
      <div class="g_m_imgs">
        <?php echo $groups->mutualGroups($get_id); ?>
      </div>
    </div>
    <?php } ?>
    ...
    <?php if($universal->MeOrNot($get_id) && $universal->isLoggedIn()){ ?>
    ...
    <?php echo $Mycircle->usersMycircles($get_id); ?>

  </div>

  <div class="prajkumar">
    <?php echo $post->getUserPost($get_id, "direct", "0"); ?>
  </div>
...
<script type="text/javascript">
  ...
  $(window).commonUserFeeds({ when: "user" });
