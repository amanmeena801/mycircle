...
<?php
  $title = "{$noti->titleNoti()} About • Mycircle";
...
<div class="badshah">
  ...
  <div class="about_div inst">
    ...
    <div class="">
      <span>Mycircle is all about exploring, messaging, groups, photos, interacting with other members and much more.</span>
      <span>Finally coming to the point, this website is developed just for fun and I have no copyright claims.</span>
      <span>Mycircle is hosted freely, so you'll find it bit slow and many of its features have been removed, such as real-time notifications and updates.</span>
    </div>
  </div>
