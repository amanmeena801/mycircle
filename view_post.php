...
<?php
  $title = "{$noti->titleNoti()} Post by {$universal->GETsDetails($post_by, "username")} • Mycircle";
  $keywords = "Mycircle, Share and capture world's moments, share, capture, view post";
