...
<?php
  $title = "{$noti->titleNoti()} Help for you • Mycircle";
  $keywords = "Mycircle, Share and capture world's moments, share, capture, help";
...
<div class="badshah">
  ...
  <div class="help_div">
    <img src="<?php echo DIR; ?>/images/needs/empty_screen_face-905ec56ff4d5ef0004450379807fd170.gif" alt="help" height="200px" width="100px">
      <p><center>Sorry, This page is currently desabled. Please write to aman.meena801@gmail.com for any support.</center></p>
  </div>
