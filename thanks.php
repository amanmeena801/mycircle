...
<div class="badshah">
  ...
  <div class="about_div inst thanks_div">
    <img src="<?php echo DIR; ?>/images/needs/glyph-instagram.png" alt="Mycircle" height="50px" width="50px">
    <div class="">
      <span>
          <center><p>Thanks for registering your Account, Enjoy <b>Mycircle.io</b>.</p>
