...
<?php
  $title = "{$noti->titleNoti()} Member not found • Mycircle";
  $keywords = "eror, 404, document not found, webpage not found, Mycircle, Share and capture world's moments";
  $desc = "There's been an error • Mycircle";
?>
